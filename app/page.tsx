    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <footer className="border-t border-gray-200 mt-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 py-6 flex justify-between items-center text-sm text-gray-600">
          <div>© 2025 Startup Analytics. All rights reserved.</div>
          <div className="flex gap-6">
            <button className="hover:text-gray-900 transition-colors duration-200">❓ Help</button>
            <button className="hover:text-gray-900 transition-colors duration-200">✉️ Contact</button>
          </div>
        </div>
      </footer>
    </div>
